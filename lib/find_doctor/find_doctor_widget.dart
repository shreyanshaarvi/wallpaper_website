...
class _FindDoctorWidgetState extends State<FindDoctorWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FindDoctorModel());
